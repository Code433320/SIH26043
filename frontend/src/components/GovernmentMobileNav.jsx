...
import { Landmark, Menu, X, LayoutDashboard, ClipboardCheck, BarChart3, User } from 'lucide-react';

const navItems = [
  { to: '/government/dashboard', label: 'Dashboard', icon: LayoutDashboard },
  { to: '/government/verify-problems', label: 'Verify Problems', icon: ClipboardCheck, isCta: true },
  { to: '/government/monitor-projects', label: 'Monitor Projects', icon: BarChart3 },
  { to: '/government/profile', label: 'Profile', icon: User },
];

export default function GovernmentMobileNav() {
    ...
    <header className="lg:hidden sticky top-0 z-40 bg-white border-b border-slate-200 px-4 py-3 flex items-center justify-between shadow-xs">
      <div className="flex items-center space-x-2.5">
        <div className="w-8 h-8 rounded-lg bg-[#006199] flex items-center justify-center text-white">
          <Landmark className="w-5 h-5 text-[#FFD444]" />
        </div>
